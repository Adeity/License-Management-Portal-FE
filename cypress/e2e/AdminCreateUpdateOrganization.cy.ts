...
describe('(admin) create update organization', () => {
  ...
  //   cy.createOrgAsAdmin(newOrgName, 'Reseller')
  //
  ...
  //   cy.createOrgAsAdmin(reseller1, 'Reseller')
  //   cy.createOrgAsAdmin(reseller2, 'Reseller')
  //   cy.createOrgAsAdmin(organization, 'Organization', reseller1)
  //
